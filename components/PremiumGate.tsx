...
export function PremiumGate({ isPremium, children }: PremiumGateProps) {
  ...
  return (
    <section className="rounded-lg border border-amber-300/30 bg-amber-300/10 p-5 shadow-card">
      <p className="text-xs font-semibold uppercase tracking-[0.22em] text-amber-700">
        Premium
      </p>
      <h2 className="mt-2 text-2xl font-semibold text-ink-900">Este recurso faz parte do plano Premium.</h2>
