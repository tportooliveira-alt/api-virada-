 ...
 *
 * Existe por um motivo só: o acesso é liberado pelo E-MAIL DA COMPRA, e o app
 * entra com Google. Quem compra com um e-mail e tenta entrar com outro fica de
...
export default function ObrigadoPage() {
  return (
    <main className="mx-auto w-full max-w-2xl px-5 py-10 sm:py-16">
      ...
      <section className="mt-8 rounded-lg border-2 border-amber-500 bg-amber-50 p-5 shadow-card">
        <h2 className="text-lg font-semibold text-ink-900">Antes de entrar, o mais importante:</h2>
