...
export const STYLE: Record<string, CellFormat> = {
  ...
  kpiLabel: {
    ...
    padding: { top: 12, right: 14, bottom: 0, left: 14 },
  ...
  kpiValue: {
    ...
    horizontalAlignment: "CENTER",
    verticalAlignment: "MIDDLE",
    padding: { top: 0, right: 14, bottom: 14, left: 14 },
    textFormat: { fontFamily: FONT, fontSize: 26, bold: true, foregroundColor: COLOR.white },
  ...
  kpiValueGold: {
    ...
    verticalAlignment: "MIDDLE",
    padding: { top: 0, right: 14, bottom: 14, left: 14 },
    textFormat: { fontFamily: FONT, fontSize: 26, bold: true, foregroundColor: COLOR.gold },
    numberFormat: { type: "CURRENCY", pattern: FORMAT.brlPlain },
  },
  kpiValueCount: {
    backgroundColor: COLOR.navyMed,
